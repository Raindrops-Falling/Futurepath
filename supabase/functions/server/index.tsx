...
function checkAchievements(userData: any, xpGained: number = 0): void {
  ...
  if (!userData.achievements.first_lesson && userData.completedMC) {
    ...
    const completedOEKeys = typeof userData.completedOE === 'object' ? Object.keys(userData.completedOE) : [];
  ...
  try {
    ...
    if (resolved.type === 'user') {
      ...
      if (question_type === 'multiple_choice') {
        ...
        // Store 50% directly to completedOE when OE questions are submitted
        currentData.completedOE[lesson_id] = 100;
